...
// colorChase(strip.Color(0, 0, 0), 5000); // White
...
uint32_t Collide(){
  ...
  int tau1 = random(100);
  int tau2 = random(100);
  int color1 = strip.Color(random(127),   random(127),   random(127));
  int color1 = strip.Color(random(127),   random(127),   random(127));
  
  int now, then;
  
  strip.show(); 
  strip.setPixelColor(pos1, color1);
  strip.setPixelColor(pos2, color2);
